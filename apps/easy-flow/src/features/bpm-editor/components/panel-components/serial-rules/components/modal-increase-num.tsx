    ...
    >
      ...
      >
        ...
        <Form.Item label="重置周期">
          ...
          <p className={styles.resetTips}>每日00:00:00，自动从初始值重新开始计数。一天内如果计数达到最大值，从0开始重新计数。</p>
        </Form.Item>
        <Form.Item label="初始值" name="startValue">
          <InputNumber min={1} max={Math.pow(10, digitsNum) - 1} value={startValue} onChange={setStartValue}
                       className={styles.formItem}/>
        </Form.Item>
      </Form>
    </Modal>
