(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    let server = (currentScript === null || currentScript === void 0 ? void 0 : currentScript.src) && new URL(currentScript.src).origin;
    if (!server) {
    ...
    const Auth = {
        getToken: (needAutoLogin, host) => __awaiter(void 0, void 0, void 0, function* () {
            if (Auth.getAuth()) {
                return Auth.getAuth();
            }
            else {
